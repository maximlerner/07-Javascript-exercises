...
// Here it will create new array with 7 empty spaces
const x = new Array(7);
console.log(x);
...
// That event handler will create new array with the info we have in the UI
...
// 2) Here we calculate the number of diposits bigger then 1000
...
//3) Here we create new object that have 2 properties deposits sum and withdrawals sum
const sums = accounts
 .flatMap(acc => acc.movements)
 .reduce((sums,cur) => {
...
// 4) Here we will take a string and capitalize the first letter of each word except the words in the exceptions array
...
dogs.forEach((dog) => {
  ...
  console.log(dog.weight,dog.recommendedFood);
});
console.log(dogs);
...
const sarahsDog = dogs.find(dog => {
  if (dog.owners.includes('Sarah')) {
    let dogStatus1;
    if (dog.curFood < dog.recommendedFood * 0.9) dogStatus1 = 'little';
    if (dog.curFood > dog.recommendedFood * 0.9 && dog.curFood < dog.recommendedFood * 1.1) dogStatus1 = 'okey';
    if (dog.curFood > dog.recommendedFood * 1.1) dogStatus1 = 'much';
    const str = `Sarah\'s dog eating too ${dogStatus1}`;
    console.log(str);
  }
});
...
// 4) 
const strStatus1 = `${ownersEatTooMuch.join(' and ')}'s dogs eat too much!`;
const strStatus2 = `${ownersEatTooLittle.join(' and ')}'s dogs eat too little!`;
console.log(strStatus1);
console.log(strStatus2);

// 5)
const dogExactly = dogs.some(dog => dog.curFood === dog.recommendedFood);
console.log(dogExactly);


// 6)
const dogOkey = dogs.some(dog => dog.curFood > dog.recommendedFood * 0.9 && dog.curFood < dog.recommendedFood * 1.1 );
console.log(dogOkey);

// 7)

const dogsOkayArray = dogs
  .filter(dog => dog.curFood > dog.recommendedFood * 0.9 && dog.curFood < dog.recommendedFood * 1.1)
  .flatMap(dog => dog.owners)
console.log(dogsOkayArray);  

// 8)

const sortedByPortion = dogs.slice().sort((a,b) => a.recommendedFood - b.recommendedFood);

console.log(dogs);
console.log(sortedByPortion);
